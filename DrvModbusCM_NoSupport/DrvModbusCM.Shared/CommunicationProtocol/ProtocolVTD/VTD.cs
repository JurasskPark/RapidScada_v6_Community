...
public class VTD
{
    ...
    public string GenerateRegisterAddress(ulong commandFunctionCode, ulong commandParametr, ulong commandRegisterAddress)
    {
        string result = string.Empty;
        return result = commandFunctionCode.ToString() + Convert.ToString(commandParametr + commandRegisterAddress).PadLeft(5, '0');
    }

    #region Формирование запроса по протоколу VTD
    public byte[] CalculateSendData(ushort DeviceAddress, ushort FunctionCode, ushort Parametr1, ushort Parametr2, ushort Parametr3, ushort[] Value)
    {
        byte[] byte_Frame = new byte[0];
        //50h = 80
        //5Fh = 95
        //if (FunctionCode == 80 || FunctionCode == 95)
        //{
            byte_Frame = Read((ushort)DeviceAddress, (ushort)FunctionCode, (ushort)Parametr1, (ushort)Parametr2, (ushort)Parametr3);
            return byte_Frame;
        //}
        //else if (FunctionCode == 5 || FunctionCode == 6)
        //{
        //    byte_Frame = Write(DeviceAddress, FunctionCode, RegisterStartAddress, HEX_WORD.ToByteArray(Value));
        //    return byte_Frame;
        //}
        ...
        //    byte_Frame = WriteMultipleCoils(DeviceAddress, FunctionCode, RegisterStartAddress, RegisterCount, tmp_Values);
        //    return byte_Frame;
        //}
        //else if (FunctionCode == 16)
        //{
        //    byte_Frame = WriteAll(DeviceAddress, FunctionCode, RegisterStartAddress, HEX_WORD.ToByteArray(Value));
        //    return byte_Frame;
        //}
    ...
    private byte[] Read(ushort DeviceAddress, ushort FunctionCode, ushort Parametr1, ushort Parametr2, ushort Parametr3)
    {
    ...
    private byte[] Write(ushort DeviceAddress, ushort FunctionCode, ushort RegisterStartAddress, byte[] Value)
    {
    ...
    private byte[] WriteAll(ushort DeviceAddress, ushort FunctionCode, ushort RegisterStartAddress, byte[] Values)
    {
    ...
    private byte[] WriteMultipleCoils(ushort DeviceAddress, ushort FunctionCode, ushort RegisterStartAddress, ushort RegisterCount, byte[] Values)
    {
        int size = Values.Length;
        byte[] frame = new byte[9 + size];
        frame[0] = (byte)(DeviceAddress);
    ...
    //    if (Device == null || Device.DeviceStatus != 1)
    //    {
    //        return byteError;
    //    }
