...
public partial class ModbusRTU
{
    ...
    public byte[] CalculateSendData(ushort DeviceAddress, ushort FunctionCode, ushort RegisterStartAddress, ushort RegisterCount, ushort[] Value)
    {
        ...
        {
            byte_Frame = Read(DeviceAddress, FunctionCode, RegisterStartAddress, RegisterCount);
            return byte_Frame;
        }
    ...
    private byte[] Read(ushort DeviceAddress, ushort FunctionCode, ushort RegisterStartAddress, ushort RegisterCount)
    {
